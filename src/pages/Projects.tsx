        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Explore the initiatives that are transforming communities across
              Tanzania. Each project is designed and implemented in partnership
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We work with local leaders to identify the most pressing
                    needs and priorities for each community.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Projects are designed together with community members,
                    ensuring cultural sensitivity and local ownership.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-primary">
                  ...
                  <p className="text-muted-foreground">
                    We provide resources, training, and support while community
                    members lead the actual implementation.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-secondary">
                    4. Sustainable Handover
                  </h3>
                  <p className="text-muted-foreground">
                    Communities are trained to maintain and expand projects
                    independently, ensuring long-term sustainability.
                  </p>
                </div>
              </div>
            </div>
